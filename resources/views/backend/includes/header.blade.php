<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#" style="background-image: url({{ @url(config('storage.images.general.image.url_path').$setting['brand_logo'])  }});"></a>
    ...
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ route('admin.auth.user.show', $logged_in_user) }}"><i class="fas fa-user"></i> Profile</span></a>
